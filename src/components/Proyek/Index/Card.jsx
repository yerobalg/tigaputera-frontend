...
const Card = ({ item, Statistik, isLoading, size }) => {
  return (
    <div className={`flex gap-1 lg:gap-3 bg-white rounded-lg shadow p-1 lg:p-3 justify-between items-center min-h-[70px] lg:mih-w-0 min-w-[${size}px] w-auto`}>
